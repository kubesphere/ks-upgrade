...
// S3StorageOptions contains configuration to access a s3 service
...
func (s *Client) CreateBucket() error {
...
func NewS3Client(options *S3StorageOptions) (Interface, error) {
